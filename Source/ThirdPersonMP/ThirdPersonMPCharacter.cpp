...
void AThirdPersonMPCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("MouseWheelUp", IE_Pressed, this, &AThirdPersonMPCharacter::SetMouseWheelUp);
	PlayerInputComponent->BindAction("MouseWheelDown", IE_Pressed, this, &AThirdPersonMPCharacter::SetMouseWheelDown);
...
void AThirdPersonMPCharacter::SetCameraRotation(AThirdPersonMPCharacter* chr)
{
	//chr->widget->SetRelativeRotation(FRotator(0.0f, 0.0f, 0.0f));
}
...
void AThirdPersonMPCharacter::BeginPlay()
{
	...
	UMyUserWidget* wid = Cast<UMyUserWidget>(widget->GetUserWidgetObject());
	wid->SetOwnerCharacter(this);
}

void AThirdPersonMPCharacter::Tick(float DelataTime)
{
	Super::Tick(DelataTime);

	if (IsLocallyControlled())
	{
		SetCameraRotation(this);
	}
...
void AThirdPersonMPCharacter::SetMouseWheelUp()
{
	if (this->CameraBoom->TargetArmLength < 2000) {
		this->CameraBoom->TargetArmLength += 10;
	}
}

void AThirdPersonMPCharacter::SetMouseWheelDown()
{
	if (this->CameraBoom->TargetArmLength > 0) {
		this->CameraBoom->TargetArmLength -= 10;
	}
}
...
{
	FVector spawnLocation = GetActorLocation() + (GetControlRotation().Vector() * 200.0f) + (GetActorUpVector() * 100.0f);
